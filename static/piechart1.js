function plotPieChart1(data, type) {
        ...
        d3.select(this)
            ...
            .style("fill", function () {
                if (this.getAttribute("test") === "yes") {
                    ...
                    return d.data.key === "Yes" ? d3.select(this).style("fill", "#3181BD") :
        ...
        .on('end', function (d, i) {
            d3.select(this)
                .on("click", function () {
                    ...
                    piechartlistener1(d.data.key, type)
                })
