function pcp(labels, movies) {
    ...
    var cat_dims = ['Attrition', 'Department', 'EducationField', 'Gender', 'JobRole',
        'MaritalStatus', 'State', 'OverTime', 'LevelofEducation', 'LevelofJob',
    ...
    var attrs = movies.columns

    var attrs_removed = ['EmployeeID', 'State', 'Gender', 'MaritalStatus', 'PerformanceRating', 'LevelofEducation', 'OverTime', 'LevelofJob'
        , 'Department', 'Attrition', 'JobRole', 'Age']
    ...
    function calDomain(d) {
        if (d === 'MonthlyIncome') {
            ...
            return d3.extent(movies, function (p) {
                return +p[d];
            })
        }
    }
